...
### 4K HDR Streaming, AI Workspace & CS2 Pro Gaming Settings
...
![Lines](https://img.shields.io/badge/Lines-408-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-display-config.git

# Oeffnen
cd dkz-display-config
